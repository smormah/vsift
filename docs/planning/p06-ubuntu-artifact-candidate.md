...
the observed FFmpeg build prefix
`ffmpeg version n9.0.1-11-ge47273f4d9-20260831`, 64 KiB per captured stream,
60 seconds for media work, 180 seconds for inference, and 16-kHz mono audio.
